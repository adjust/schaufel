...
print_usage()
{
    printf("usage\n"
           ...
           "        :       by a semicolon.\n"
           "        :       For postgres, appending a third, colon-separated\n"
           "        :       field <host>:<port>:<socket dir> connects via that\n"
           "        :       unix socket directory instead of TCP; <host>:<port>\n"
           "        :       are still used for table naming.\n"
